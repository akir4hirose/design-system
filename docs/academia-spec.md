...
動画のコンテンツは、ユーザーが持つ1つのチャンネルに紐づいている。

また、Academiaは、ポイ活を目的としている医師がいない（ポイ活機能がない）ので、純粋に学びに意欲のある医師が存在している。
...
#### 機能概要
動画コンテンツが、縦スクロールをすることでコンテンツの表示・視聴をすることができる。

#### ユースケース
- ユーザーがコンテンツを視聴することができる
- ユーザーは会員情報を保持してなくとも、コンテンツを視聴することができる
- 縦スクロールをすることで、次のコンテンツを視聴することができる
...
#### 機能概要
ユーザー自身が、検索したいキーワードを入力しコンテンツ（動画やスライド）やチャンネルを検索することができる
...
| 日付 | 内容 | 対応者 |
|------|------|--------|
| 2025-12-13 | 初版作成 | Akira |

---

### 2.4 フォローフォロワー機能 {#follow}

#### 機能概要
ユーザーが、繋がりたいユーザーをフォローすることができる。後々コミュニティとして、メッセージを送付できるようになる
